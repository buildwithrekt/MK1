...
const typeStyles: Record<string, { color: string; prefix: string; glow: string }> = {
  INFO: { color: "text-zinc-400", prefix: "│", glow: "" },
  WARN: { color: "text-yellow-400", prefix: "⚠", glow: "drop-shadow-[0_0_3px_rgba(253,224,71,0.5)]" },
  WARNING: { color: "text-yellow-400", prefix: "⚠", glow: "drop-shadow-[0_0_3px_rgba(253,224,71,0.5)]" },
  ERROR: { color: "text-red-500", prefix: "✗", glow: "drop-shadow-[0_0_3px_rgba(239,68,68,0.5)]" },
  TRADE: { color: "text-zinc-400", prefix: "◆", glow: "" },
  BUY: { color: "text-green-400", prefix: "◆", glow: "drop-shadow-[0_0_5px_rgba(74,222,128,0.7)]" },
  SELL: { color: "text-red-400", prefix: "◆", glow: "drop-shadow-[0_0_5px_rgba(248,113,113,0.7)]" },
  OPEN: { color: "text-blue-400", prefix: "◆", glow: "drop-shadow-[0_0_5px_rgba(96,165,250,0.7)]" },
  CLOSE: { color: "text-purple-400", prefix: "◆", glow: "drop-shadow-[0_0_5px_rgba(192,132,252,0.7)]" },
  CLOSE_WIN: { color: "text-green-400", prefix: "◆", glow: "drop-shadow-[0_0_5px_rgba(74,222,128,0.7)]" },
  CLOSE_LOSS: { color: "text-orange-400", prefix: "◆", glow: "drop-shadow-[0_0_5px_rgba(251,146,60,0.7)]" },
  TRAIL: { color: "text-orange-400", prefix: "◆", glow: "drop-shadow-[0_0_5px_rgba(251,146,60,0.7)]" },
};
    ...
    >
      ...
      <div className="relative">
        ...
        >
          {logs.length === 0 ? (
            <div className="text-green-500 flex items-center gap-2">
              ...
              <span className="animate-pulse">Waiting for banana zone...</span>
            </div>
          ) : (
            logs.map((log, index) => {
        ...
        <div className="px-4 py-1.5 bg-green-900/30 border-t border-green-500/30 flex items-center justify-between font-mono text-xs">
          <span className="text-green-500">◄ READY ► MEM: OK ► CPU: OK</span>
          <span className="text-green-600 animate-pulse">████████████░░░░ 75%</span>
        </div>
      </div>
    </div>
  );
